...
analytics, advertising, telemetry, remote APIs, data synchronization, or developer-operated
backend.
...
DevTools starts passive Long Polling observation for the inspected tab through the Microsoft Edge
DevTools Network API. WebSocket and Server-Sent Events instrumentation remains disabled until the
